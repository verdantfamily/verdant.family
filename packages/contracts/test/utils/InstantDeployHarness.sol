...
/// @title InjectedInstantDeployHarness
/// @notice `script/DeployInstant.s.sol` with the two seams a test needs, and nothing else.
///
/// @dev The same shape as `InjectedAgenDeployHarness`, for the same two reasons. A script's
...
/// the hook mining, the order of the four phases, and every assertion the script makes when
...
contract InjectedInstantDeployHarness is DeployInstant {
