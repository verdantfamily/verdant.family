...
/** AgenEngineFactory, entire. */
export const agenEngineFactoryAbi = [
  {
    "type": "constructor",
    "inputs": [
      {
      ...
      },
      {
        "name": "deployer_",
        "type": "address",
        "internalType": "contract AgenEngineDeployer"
      },
      {
        "name": "registry_",
        "type": "address",
      ...
      },
      {
        "name": "hook_",
        "type": "address",
        "internalType": "contract AgenEngineHook"
      },
      {
        "name": "treasury_",
        "type": "address",
    ...
    "inputs": [
      {
        "name": "manifest",
        "type": "tuple",
        "internalType": "struct AgenEngineFactory.Manifest",
        "components": [
          {
            "name": "name",
            "type": "string",
          ...
          },
          {
            "name": "config",
            "type": "tuple",
            "internalType": "struct AgenRuleLib.Config",
            "components": [
              {
                "name": "engineVersion",
                "type": "uint8",
              ...
              },
              {
                "name": "stages",
                "type": "tuple[]",
                "internalType": "struct AgenRuleLib.Stage[]",
                "components": [
                  {
                    "name": "threshold",
                    "type": "uint128",
              ...
              },
              {
                "name": "buyTiers",
                "type": "tuple[]",
                "internalType": "struct AgenRuleLib.Tier[]",
                "components": [
                  {
              ...
              },
              {
                "name": "distribution",
                "type": "tuple[]",
                "internalType": "struct AgenRuleLib.Share[]",
                "components": [
                  {
                    "name": "kind",
                    "type": "uint8",
                    "internalType": "enum AgenRuleLib.RecipientKind"
                  },
                  {
                    "name": "recipient",
                    "type": "address",
...
/** AgenEngineHook, entire. */
export const agenEngineHookAbi = [
  {
    "type": "constructor",
    "inputs": [
      {
  ...
  },
  {
    ...
    "inputs": [
      ...
      },
      {
        "name": "vault",
        "type": "address",
        "internalType": "contract AgenEngineVault"
      }
    ],
    "outputs": [
      {
  ...
  {
    "type": "error",
    "name": "FirstStageThresholdNonZero",
    "inputs": [
      {
        "name": "provided",
        "type": "uint128",
...
/** AgenEngineVault, entire. */
export const agenEngineVaultAbi = [
  {
    "type": "constructor",
    "inputs": [
      {
...
/** InstantFactory, entire. */
export const instantFactoryAbi = [
  {
    "type": "constructor",
    "inputs": [
      {
      ...
      },
      {
        "name": "hook_",
        "type": "address",
        "internalType": "contract InstantHook"
      },
      {
        "name": "deployer_",
        "type": "address",
        "internalType": "contract InstantDeployer"
      },
      {
        "name": "marketRegistry_",
        "type": "address",
    ...
    "inputs": [
      {
        "name": "params",
        "type": "tuple",
        "internalType": "struct InstantFactory.CreateParams",
        "components": [
          {
            "name": "name",
            "type": "string",
    ...
    "outputs": [
      {
        "name": "created",
        "type": "tuple",
        "internalType": "struct InstantFactory.Created",
        "components": [
          {
            "name": "token",
            "type": "address",
...
/** InstantDeployer, entire. */
export const instantDeployerAbi = [
  {
    "type": "constructor",
    "inputs": [
      {
    ...
    "outputs": [
      {
        "name": "vault",
        "type": "address",
        "internalType": "contract InstantFeeVault"
      }
    ],
    "stateMutability": "nonpayable"
  },
...
/** InstantFeeVault, entire. */
export const instantFeeVaultAbi = [
  {
    "type": "constructor",
    "inputs": [
      {
...
export const boostEscrowAbi = [
  {
    ...
    "inputs": [
      ...
      {
        "name": "instantFactory_",
        "type": "address",
        "internalType": "contract IInstantFactory"
      },
      {
        "name": "agenRouter_",
        "type": "address",
        "internalType": "contract IAgenRouter"
      },
      {
        "name": "poolManager_",
        "type": "address",
    ...
    "outputs": [
      {
        "name": "state",
        "type": "tuple",
        "internalType": "struct BoostEscrow.BoostState",
        "components": [
          {
            "name": "vault",
            "type": "address",
...
/** BoostEscrowFactory, entire. */
export const boostEscrowFactoryAbi = [
  {
    "type": "constructor",
    "inputs": [
      {
    ...
    "outputs": [
      {
        "name": "escrow",
        "type": "address",
        "internalType": "contract BoostEscrow"
      }
    ],
    "stateMutability": "nonpayable"
  },
...
/** BoostTreasury, entire. */
export const boostTreasuryAbi = [
  {
    "type": "constructor",
    "inputs": [
      {
      ...
      },
      {
        "name": "escrowFactory_",
        "type": "address",
        "internalType": "contract BoostEscrowFactory"
      }
    ],
    "stateMutability": "nonpayable"
  },
    ...
    "outputs": [
      {
        "name": "state",
        "type": "tuple",
        "internalType": "struct BoostTreasury.PlatformState",
        "components": [
          {
            "name": "registered",
            "type": "bool",
    ...
    "inputs": [
      {
        "name": "vault",
        "type": "address",
        "internalType": "contract IInstantFeeVault"
      }
    ],
    "outputs": [
      {
...
/** CreatorSeatFactory, entire. */
export const creatorSeatFactoryAbi = [
  {
    "type": "constructor",
    "inputs": [
      {
    ...
    "outputs": [
      {
        "name": "seat",
        "type": "address",
        "internalType": "contract CreatorSeat"
      }
    ],
    "stateMutability": "nonpayable"
  },
